...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const rainButton = null; // bouton supprimé
  ...
  startScreen.addEventListener('click', () => {
    ...
    profileBlock.style.zIndex = 20;
    skillsBlock.style.zIndex = 20;
  ...
  const bioMessages = [
    "CEO of Noxahook Project and Intelx Contributor.",
    "\"Hello, World!\""
  ];
  let bioText = '';
  let bioIndex = 0;
